...
- **SQLite is the default database:** All data is saved in `backend/db.sqlite3`. This is simple for local development, but production usually uses PostgreSQL or MySQL.
